...
const TradeAccountComp = () => {
    ...
    useEffect(() => {
        ...
        const accountCodes = overView.liveAccounts.map((i: TradeAccount) => i.accountCode);
        const demoAccountCodes = overView.demoAccounts.map((i: TradeAccount) => i.accountCode);
        const accountIds = overView.liveAccounts.reduce((acc: any, i: TradeAccount) => {
            acc[i.accountCode] = i.id;
            return acc;
        }, {});

        const demoAccountIds = overView.demoAccounts.reduce((acc: any, i: TradeAccount) => {
            acc[i.accountCode] = i.id;
            return acc;
        }, {});
    ...
    return (
        <Layout>
            ...
            {
                tradingAccount && tradingAccountIds && <TradingAccountComp
                    tradingAccountId={demo ? tradingDemoAccountIds[slug as string] : tradingAccountIds[slug as string]}
                    assets={assets}
