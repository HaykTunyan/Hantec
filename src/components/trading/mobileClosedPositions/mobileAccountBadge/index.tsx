...
const MobileAccountBadge = ({account}: IMobileAccountBadge) => {
    ...
    return (
        <div
            ...
            <div className="flex flex-col w-full">
                ...
                {
                    closeTime && <AccountInfoRow name={tableHeaders["close-time"]} value={formatTimestamp(closeTime)}/>
                }
                {
                    closePrice &&
                    <AccountInfoRow name={tableHeaders["close-price"]} value={roundToTwoDecimel(closePrice)}/>
                }
...
export default MobileAccountBadge;
