...
const ContinueHere = ({setSelectedTab, lineWidth}: IStepsInfo) => {
        ...
        <div
            ...
            <div className="max-w-[362px] w-full mx-auto flex flex-col gap-6 tablet:mb-10">
                ...
                <span className="text-20-20 text-default font-medium">
                    Please select the issuing country and document type.
                </span>
                <div className="w-full p-6 tablet:px-4 flex items-center gap-3 bg-orange-extra-light rounded-[8px]">
                    ...
                    <button
                        className={"btnPrim"}
                        style={{flex: "0 0 auto"}}
                        onClick={() => setIsDisclaimerOpened(true)}
                    >
                        Manual Verification
                    </button>
                </div>
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="flex flex-col gap-2">
                                <div
                                    ...
                                    `}>
                                    <span
                                        className={`text-14 font-medium tracking-wider ${selectedMethod === "national_id" ? "text-white" : ""}`}>National ID</span>
                                    {
                                ...
                                <div
                                    ...
                                    `}>
                                    <span
                                        className={`text-14 font-medium tracking-wider ${selectedMethod === "passport" ? "text-white" : ""}`}>Passport</span>
                                    {
                                ...
                                <div
                                    ...
                                    `}>
                                    <span
                                        className={`text-14 font-medium tracking-wider ${selectedMethod === "driver_license" ? "text-white" : ""}`}>Driver’s license</span>
                                    {
                                ...
                                <span
                                    className="text-14_16 text-grey-seccondary underline custom-underline-all self-end mt-2">
            ...
            <div className="flex flex-col w-full h-[61px]">
                ...
                <div className="py-2 px-4 flex items-center justify-between border-t border-grey-extra-light fixed bottom-0 w-[58%] tablet:w-full bg-grey-exrta-ligth-extra">
                    ...
                    <button
                        className="btnPrim"
                        disabled={disabled}
                        onClick={() => setSelectedTab("disclaimer2")}
                    >
                        Continue
                    </button>
                </div>
