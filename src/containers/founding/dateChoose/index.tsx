...
interface IMobileDateChoose {
    selectToDate: (x: string) => void;
    selectFromDate: (x: string) => void;
    toDate: string;
    fromDate: string;
}
...
const DateChoose = ({
    ...
    const [lastDate, setLastDate] = useState<any>(new Date());
    ...
    return (
        <div className={"flex items-center gap-2 flex-wrap"}>
            <div
                ...
                className={"w-[240px] flex items-center gap-2 px-[14px] py-[12px] justify-between rounded-8 border border-grey-extra-light dateContainer bg-white cursor-pointer"}>
                {
                    isOpenFirst &&
                    <SingleDatepicker
                        name="date-input"
            ...
            <span className={"text-grey-seccondary"}>To</span>
            <div
